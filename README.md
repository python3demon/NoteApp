...
[![Version 0.4.0](https://img.shields.io/badge/version-0.4.0-red.svg)](https://github.com/python3demon/NoteApp)
...
## Дорожная карта
### ✅ Реализовано в текущей ветке (`v0.4.0-alpha`)
- [x] Полный редизайн интерфейса под темный минимализм
- [x] Открытие любых файлов через системный проводник
- [x] Сохранение изменений по горячим клавишам `Ctrl + S`
- [x] Индикатор названия открытого файла в шапке приложения

### В ближайших планах
- [ ] Разработка системы вкладок (Tabs) для работы с несколькими файлами
- [ ] Кнопка быстрого создания нового чистого документа (`+`)

### Прошлые этапы
- [x] Разработка базового прототипа интерфейса (`v0.1.0-alpha`)
- [x] Перенос процедурного кода в ООП-классы (`v0.2.0-alpha`)
- [x] Рефакторинг: инкапсуляция данных, константы и PEP 8 (`v0.2.1-alpha`)
- [x] Создание класса NoteManager и сохранение заметок в файлы .txt (`v0.3.0-alpha`)
